...
break;}
return duplicate;};function getSuggestionsList(){var url=vm.apiUrl;$http({method:'GET',url:url}).then(function(response){debugger
$log.log(response);vm.suggestionsArr=response.data;},function(response){$log.log("MultiSelect typeahead ----- Unable to fetch list");});};}})();