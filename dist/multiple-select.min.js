...
_this.shouldShowInput();};this.removeAll=function(){_this.modelArr=[];_this.shouldShowInput();};this.onSuggestedItemsClick=function(selectedValue){if(_this.multiple!=null&&_this.multiple!=""){if(_this.modelArr.length<_this.multiple){_this.modelArr.push(selectedValue);_this.inputValue="";}}
...
break;}
return duplicate;};this.getSuggestionsList=function(){var url=_this.apiUrl;_this.$http({method:'GET',url:url}).then(function(response){_this.$log.log(response);_this.suggestionsArr=response.data;},function(response){_this.$log.log("MultiSelect typeahead ----- Unable to fetch list");});};if(this.modelArr===null||this.modelArr===""||this.modelArr===undefined){this.modelArr=[];}
